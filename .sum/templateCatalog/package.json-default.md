...
"private": true,
"scripts": {
"dev": "cross-env FORCE*COLOR=1 next dev --turbo",
"build": "next build",
"start": "next start",
...
"test:check": "cross-env FORCE*COLOR=1 node --experimental-vm-modules node_modules/jest/bin/jest.js --coverage --runInBand --silent --passWithNoTests",
...
"eslint:fix": "eslint --no-error-on-unmatched-pattern './src/\*_/_.+(js|jsx|ts|tsx)' --fix",
