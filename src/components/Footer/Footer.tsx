    ...
    <footer className={twMerge(footer({ align, spacing }), className)}>
      <div className='flex flex-col items-center sm:flex-row-reverse sm:justify-between'>
        <div className='flex space-x-6'>
          <Link href='https://github.com/wesolowski' className='group'>
            <span className='sr-only'>Wesolowski on GitHub</span>
            <svg aria-hidden='true' className='h-6 w-6 fill-slate-800 group-hover:fill-slate-900'>
